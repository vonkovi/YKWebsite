...
order: 1
description: "A distributed, agent-based simulation that runs 100+ LLMs in parallel to watch emergent social behavior unfold in real time."
lede: "A distributed, agent-based simulation that runs 100+ LLMs in parallel to watch emergent social behavior unfold in real time."
year: 2026
stack: ["Python", "LangGraph", "asyncio", "WebSockets"]
